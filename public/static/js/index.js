...
function setup() {
  ...
  assets.spiderSpriteAttackLeft = getSpriteFromSheet(assets.spiderSheet,64,64,5,1,0)
  assets.spiderSpriteAttackRight = getSpriteFromSheet(assets.spiderSheet,64,64,5,3,0)
	textSize(25)
	imageMode(CENTER)
